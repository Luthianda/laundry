            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="service_name" id="name" class="form-control"
                            placeholder="Enter your type of service" value="<?php echo $name_form; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label">Price <span class="text-danger">*</span></label>
                        <input type="number" name="price" id="price" class="form-control" placeholder="Enter your price"
                            value="<?php echo $price_form; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea name="description" id="description" cols="30" rows="10"
                            class="form-control"><?php echo $description_form; ?></textarea>
                    </div>
                    <div class="mb-3">
